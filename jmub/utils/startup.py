...
LOGS = logging.getLogger("اعداد ريثون")
...
async def saves():
    ...
    try:
        ...
        await jmub(JoinChannelRequest("@srethon"))
        await jmub(JoinChannelRequest("@shhuv"))
        await jmub(JoinChannelRequest("@@deoou"))
        await jmub(JoinChannelRequest("@shhuv1"))
