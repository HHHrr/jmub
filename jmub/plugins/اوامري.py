...
ROE = """** اهلا بك عزيزي المستخدم في قائمة اوامر ريثون
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("اوامري") and event.query.user_id == jmub.uid:
            buttons = [
                [Button.inline("معلومات ريثون", data="AOMRDB")],
                [
...
async def varssett(event):
    await event.edit(
        """اهلا بك في قائمة اوامر سورس ريثون هذه بعض المعلومات عن ريثون:

- سورس ريثون يمتلك اكثر من 100 أمر 
- ريثون هو افضل سورس عربي يتميز بالحماية
المطور: @HvvHH""",
        buttons=[
            [Button.inline("رجوع", data="namevar")],
        ],
...
* يمكنك الحصول على  كليشة جاهزة من هذه القناة @nnuuun
ملاحظة : يمكنك استخدام الاوامر في اي دردشة او محادثة
اوامر فارات سورس ريثون @HvvHH""",
        buttons=[
            [Button.inline("رجوع", data="pmvars")],
