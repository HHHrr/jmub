...
async def amireallyalive(event):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "**سورس ريثون يعمل بنجاح**"
...
def jmthonalive_text():
    EMOJI = gvarstatus("ALIVE_EMOJI") or "  ✥ "
    jmthon_caption = "**سورس ريثون يعمل بنجاح**\n"
...
ROZ_PIC = "https://telegra.ph/file/061a427fe92001cfd8c8e.jpg"
RAZAN = Config.TG_BOT_USERNAME
ROZ_T = (
    f"**⌯︙بوت ريثـون يعمل بنجاح 🤍،**\n"
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("السورس") and event.query.user_id == jmub.uid:
            buttons = [
                [
                    Button.url("قنـاة السـورس ⚙️", "https://t.me/srethon"),
                    Button.url("المطـور 👨🏼‍💻", "https://t.me/Hvvhh"),
                ]
            ]
